...
class QuickChart:
    def __init__(self):
        ...
        self.version = "2.9.4"
        self.key = None
        self.scheme = os.environ.get("QUICKCHART_BASE_URL_SCHEME") or "https"
        self.host = os.environ.get("QUICKCHART_BASE_URL_HOST") or "quickchart.io"
